<template>
  <div
    class="bg-blue-300 min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0"
  ...
  >
    ...
    >
      <section>
        <h3 class="font-semibold text-xl text-gray-400 tracking-wider">
          Welcome to ecom-Laptops
        </h3>
        <p class="text-gray-600 pt-2 tracking-wide">

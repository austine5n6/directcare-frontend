<template>
  <div id="home">
    <div class="leading-normal tracking-normal" id="main-body">
      ...
      <nav
        class="text-sm font-semibold mb-6 flex justify-center"
      ...
      >
        <ol class="list-none p-0 inline-flex">
          ...
          <li class="flex items-center">
            <nuxt-link to="/dashboard" class="text-gray-600"
              >Dashboard</nuxt-link
            >
          </li>
        </ol>
    ...
    <div class="flex justify-center">
      <nuxt-link
        to="/"
        class="bg-gray-300 font-semibold px-10 py-6 mr-4 hover:shadow-lg"
      >
        <svg
        ...
        <span class="flex justify-center"> My Cart </span>
      </nuxt-link>
